"""
databricks-MACAW-alice  --  Databricks managed SQL MCP via SecureMCPProxy, bound to alice (admin).
...
each tools/call is relayed through the mesh AS alice -> proxy -> Databricks SQL.
...
REGISTER (token passed as an env export in the register command -- NOT stored in this file):
    claude mcp add databricks-MACAW-alice --scope user \
      -- bash -lc 'source /home/itsadijmbt/demo4/venv/bin/activate && \
         ...
         python databricks_MACAW_alice.py'
"""

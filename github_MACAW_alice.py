"""
github-MACAW-alice  --  GitHub remote MCP via SecureMCPProxy, bound to alice (admin).
...
each tools/call is relayed through the mesh AS alice -> proxy -> GitHub.

REGISTER (token passed as an env export in the register command -- NOT stored in this file):
 claude mcp add github-MACAW-alice --scope user \

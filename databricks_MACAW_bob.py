"""
databricks-MACAW-bob  --  Databricks managed SQL MCP via SecureMCPProxy, bound to bob (manager).
...
each tools/call is relayed through the mesh AS bob -> proxy -> Databricks SQL.
